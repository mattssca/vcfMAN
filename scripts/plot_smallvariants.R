...
plot.title.ideo = ggplot() + 
  ...
  annotate("text", x = 1, y = 3, size = 8, label = "Chromosome dependant ideogram, SNVs are plotted (superimposed) as green vertical lines along each autosome (grey), revealing chromosomal", hjust = 0) +
  annotate("text", x = 1, y = 1, size = 8, label = "regions with decreased SNV density.", hjust = 0) +
  xlim(0, 100) +
  ylim(0,20) +
